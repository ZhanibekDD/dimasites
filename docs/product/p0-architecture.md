...
Логин и случайный пароль создаются только на хостинге командой. Конфигурация
хранится в JSON с правами `0600`, чтобы доступ работал и на конфигурациях
shared-hosting, где PHP запрещает `include` файлов за пределами `public_html`:
